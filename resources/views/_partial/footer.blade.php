<footer id="fh5co-footer" role="contentinfo">	
    <div class="container">
        ...
        <div class="col-md-4 col-sm-12 col-sm-push-0 col-xs-12 col-xs-push-0">
            ...
            In the logo of vKirirom - you will find '<span style="color: orange;">v</span>' in orange and <span style="color: green;">'Kirirom'</span> in green. The orange colour represents the people who live in Kirirom. This is the colour of joy and creativity. It also reminds us  of the robes monks wear in Cambodia. The green represents the nature and its beauty.
        </div>					
        <div class="col-md-12 fh5co-copyright text-center">
            &copy; 2018 Designed by <a href="http://kit.vkirirom.com/" target="_blank"> Kirirom Institute of Technology</a>
        </div>
    </div>
</footer>