...
<body>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box" data-animate-effect="fadeIn">
                            ...
                            <p>Far far away, behinxd the word mountains, far from the countries Vokalia and Consonantia, there
    ...
    <div class="fh5co-section-with-image">
        ...
        <div class="fh5co-box animate-box">
            <h2>Security, Comfort, &amp; Conveniencegkhhhghjghjghjghjg</h2>
        ...
        <div class="container">
            <div class="col-md-4 col-sm-12 col-sm-push-0 col-xs-12 col-xs-push-0">
                ...
                <p>vKirirom Pine Resort is located amongst the pine trees of Kirirom Mountain. Here at vKiriom, we try to preserve
                    the natural beauty of the environment. Our building locations are properly studied so that we avoid cutting
                    down many trees.</p>
            </div>
            <div class="col-md-4 col-sm-12 col-sm-push-0 col-xs-12 col-xs-push-0">
                <h3>Kirirom Institute of Technology</h3>
                <div>
                    <label>KIT</label>adapts a new style of learning with an effective new educational techniques as a boarding
                    school.</div>
            ...
            <div class="col-md-4 col-sm-12 col-sm-push-0 col-xs-12 col-xs-push-0">
                ...
                <p>In the logo of vKirirom - you will find '
                    ...
                    <span style="color: green;">'Kirirom'</span> in green. The orange colour represents the people who live in Kirirom. This is the colour
                    of joy and creativity. It also reminds us of the robes monks wear in Cambodia. The green represents the
