      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Rate</a>
          </div>
    	...
    	<div class="container-fluid">
    		...
    		<div class="col-md-4">
        		...
        		<a href="{{url('rate/$rate->type_ID')}}">
            		...
            		<div class="card-body">
                		<img style="width: 260px;" src="{{asset('uploads/image/'.$rate->image)}}">
                    	<p class="card-category">{{$rate->price}} $</p>
            		</div>
            		<div class="card-footer">
                		<div class="stats">
                   		 <i class="material-icons">calendar_today</i>{{$rate->date}}
               		 	</div>
           		 	</div>
       		 	</div>
    		</div>	
