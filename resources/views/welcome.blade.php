<!DOCTYPE html>
	...
	<a href="/Vkbooking/public"><img src="{{asset('frontend/images/HomePage/vKirirom.svg')}}" alt="vKirirom logo" title="logo"/></a>
	<nav role="navigation">
	<ul>
	...
	<li class="zoom"><a href="https://www.instagram.com/vkirirom_pine_resort/" target="_blank"><img src="{{asset('frontend/images/instagram.svg')}}" alt="www.instagram.com" title="instagram"/></a></li>
	</ul>
	</nav>
	</div>
	</div>
	...
	<input name="DateOut" type="text" id="datepicker"/>
	</div>
	</div> -->
